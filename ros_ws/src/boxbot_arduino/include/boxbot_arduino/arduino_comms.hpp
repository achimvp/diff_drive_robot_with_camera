#ifndef BOXBOT_ARDUINO_ARDUINO_COMMS_H
#define BOXBOT_ARDUINO_ARDUINO_COMMS_H
...
public:
  ...
  void readIMUValues(double acc[3], double gyro[3]);
...
#endif // BOXBOT_ARDUINO_ARDUINO_COMMS_H